...
ccle_labels = get_cell_line_labels(data_root = data_root)
...
r2_df.to_csv(os.path.join(res_path, 'drug_response_by_cancer_r2.csv.gz'))
mse_df.to_csv(os.path.join(res_path, 'drug_response_by_cancer_mse.csv.gz'))
...
r2_df.to_csv(os.path.join(res_path, 'ps_drug_response_by_cancer_r2.csv.gz'))
mse_df.to_csv(os.path.join(res_path, 'ps_drug_response_by_cancer_mse.csv.gz'))
